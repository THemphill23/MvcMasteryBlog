...
namespace MvcMasteryBlog.Migrations
{
    ...
    [Migration("20191017193608_TimeMigration")]
            ...
            modelBuilder.Entity("MvcMasteryBlog.Models.Blog", b =>
                {
                    ...
                    b.HasData(
                        new { ID = 1, Author = "Chef Bobby", Body = "Lorem Ipsum", DateTime = new DateTime(2019, 10, 17, 15, 36, 8, 85, DateTimeKind.Local), GenreID = 1, Image = "image", Title = "Food Blog" },
                        new { ID = 2, Author = "Chef Bobby", Body = "Lorem Ipsum", DateTime = new DateTime(2019, 10, 17, 15, 36, 8, 86, DateTimeKind.Local), GenreID = 1, Image = "image", Title = "Food Blog" }
                    );
                });
